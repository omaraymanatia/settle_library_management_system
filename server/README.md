...
The easiest way to run the project is using Docker. This method requires no local Python setup and includes a PostgreSQL database.

#### Prerequisites
- Docker and Docker Compose installed
- Available ports: 8000, 3000

#### Installation
1. **Clone the repository:**
   ```bash
   git clone <repository-url>
   cd settle-assessment
   ```
...
### Manual Testing
1. **Start the server:** `python start_server.py` or `./docker-setup.sh up`
...
### Docker Testing
- **Start services:** `./docker-setup.sh up`
- **Seed database:** `./docker-setup.sh seed`
